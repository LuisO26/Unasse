$(document).ready(function() {
        ...
        $("#addQuestion").click(function() {
                ...
                $("#pregunta").append("<div class='form-group'><label for='pregunta'>Pregunta " + num + "</label><input type='text' class='form-control' name='pregunta_" + num + "' id='pregunta_" + num + "' placeholder='Ingrese pregunta " + num + "...'></div><label for='respuesta'>Respuestas</label><div class='form-group'><div class='col-md-3'><input type='text' class='form-control' name='respuesta1_" + num + "' id='respuesta1_" + num + "' placeholder='Ingrese respuesta correcta...'></div><div class='col-md-3'><input type='text' class='form-control' name='respuesta2_" + num + "' id='respuesta2_" + num + "' placeholder='Ingrese respuesta adicional...'></div><div class='col-md-3'><input type='text' class='form-control' name='respuesta3_" + num + "' id='respuesta3_" + num + "' placeholder='Ingrese respuesta adicional...'></div><div class='col-md-3'><input type='text' class='form-control' name='respuesta4_" + num + "' id='respuesta4_" + num + "' placeholder='Ingrese respuesta adicional...'></div></div>");
