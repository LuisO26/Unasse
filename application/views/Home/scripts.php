<!-- Scripts -->
    ...
    <script type="text/javascript" src="<?= base_url()?>/assets/js/tweet/carousel.js"></script> 
    <script type="text/javascript" src="<?= base_url()?>/assets/js/tweet/scripts.js"></script> 
    <script type="text/javascript" src="<?= base_url()?>/assets/js/tweet/tweetie.min.js"></script> 
    <!-- Background Video -->
